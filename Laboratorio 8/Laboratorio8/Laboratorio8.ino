/////////////////////////////////////////////////////////
//Laboratorio 8 Estephan Portales 19826
//////////////////////////////////////////////////////////
...
unsigned char rebote1;// variables botones y banderas
...
void setup() {
  ...
  pinMode(boton1, INPUT_PULLUP);//Botones
...
void loop() {
  ...
  if (digitalRead(boton1) == LOW) {// Antirrebote para botones y aumentar o disminuir estado para mostrar diferentes fotos
    rebote1 = 1;
  } else if (digitalRead(boton1) == HIGH && rebote1 == 1) {
  ...
  if (digitalRead(boton2) == LOW) {
    rebote2 = 1;
  } else if (digitalRead(boton2) == HIGH && rebote2 == 1) {
  ...
  if (bandera == 1) {// si cambiamos foto 

    /////////////////////////////mostrar fotos
    switch (estado) {
      case (1): myFile = SD.open("1.TXT", FILE_READ); break;//seleccionar fotos
      case (2): myFile = SD.open("2.TXT", FILE_READ); break;
      case (3): myFile = SD.open("3.TXT", FILE_READ); break;
      case (4): myFile = SD.open("4.TXT", FILE_READ); break;
    }
    contador = 0;
    unsigned int meterdatos = 0;
