...
# 230 "MAINMASTER.c"
    ...
    while (1)
    {
        ...
        temperatura1 = (temp_temp1 * (0.7058)) - 68;
        ...
        if (bandera_info) {
            ...
            I2C_Master_Start();
            I2C_Master_Write(0x51);
            temp_temp2 = I2C_Master_Read(0);
            I2C_Master_Stop();
            _delay((unsigned long)((200)*(8000000/4000.0)));

            I2C_Master_Start();
            I2C_Master_Write(0x50);
            I2C_Master_Write(0b11000000);
            I2C_Master_Stop();
            _delay((unsigned long)((200)*(8000000/4000.0)));

            I2C_Master_Start();
            I2C_Master_Write(0x51);
            temp_luz1 = I2C_Master_Read(0);
            I2C_Master_Stop();
            _delay((unsigned long)((200)*(8000000/4000.0)));
        ...
        if ((temperatura1 < temp_nom || temperatura2 < temp_nom)) {
